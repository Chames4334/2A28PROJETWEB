...
-- Sample users for forum testing
INSERT INTO `users` (`nom`, `prenom`, `email`, `password_hash`, `status`) VALUES
('Admin', 'Test', 'admin@greenassurance.fr', '$2y$10$n9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36P4/eMe', 'active'),
('User', 'Test', 'user@greenassurance.fr', '$2y$10$n9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36P4/eMe', 'active');

-- Assign roles to sample users
INSERT INTO `user_roles` (`user_id`, `role_id`) VALUES
(1, 1), -- admin user gets admin role
(2, 3); -- regular user gets client role

-- Sample forum posts
INSERT INTO `post` (`user_id`, `titre`, `contenu`, `is_pinned`, `statut`) VALUES
(1, '🌿 Bienvenue sur le Forum Green Assurance !', 'Bienvenue dans notre espace communautaire. Ici vous pouvez poser vos questions, partager vos expériences et échanger avec d\'autres assurés. N\'hésitez pas à participer !', 1, 'actif'),
(1, 'Comment fonctionne l\'assurance vie verte ?', 'Je souhaite comprendre les spécificités de l\'assurance vie écologique proposée par Green Assurance. Quels sont les critères pour les investissements responsables ?', 0, 'actif'),
(1, 'Retour d\'expérience : sinistre traité en 48h', 'Je voulais partager mon expérience positive. Suite à un dégât des eaux, mon dossier a été traité en moins de 48h. Merci à l\'équipe !', 0, 'actif');
