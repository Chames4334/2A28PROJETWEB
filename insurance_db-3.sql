...
INSERT INTO `post` (`id`, `user_id`, `titre`, `contenu`, `is_pinned`, `statut`, `created_at`, `updated_at`, `tag_id`, `ai_score`) VALUES
(2, 1, 'Bienvenue', 'Bienvenue dans notre forum!!', 0, 'actif', '2026-04-21 10:18:54', '2026-04-28 09:36:34', 2, NULL),
(3, 1, 'Règles du forum', '- Soyez respectueux\r\n- Pas de hors sujets', 0, 'actif', '2026-04-21 10:23:12', '2026-04-28 09:18:09', 1, NULL),
(4, 1, 'Probléme', 'qdfqdsfqdfqdf', 1, 'actif', '2026-04-28 09:18:53', '2026-04-28 09:40:54', 3, NULL),
(5, 1, 'Petit blem', 'Salut, j\'ai un problème', 0, 'actif', '2026-05-03 23:06:40', '2026-05-03 23:06:40', 4, NULL),
(6, 1, 'Bonjour', 'Je m\'appelle Youssef', 0, 'actif', '2026-05-03 23:37:43', '2026-05-03 23:37:44', 2, 100),
(10, 1, 'Salut les membres', 'Bonsoir, comment allez-vous?', 0, 'actif', '2026-05-03 23:49:06', '2026-05-03 23:49:06', 1, NULL),
(12, 1, 'bonjour', 'je suis nouveau au forum.', 0, 'actif', '2026-05-04 00:07:30', '2026-05-04 00:07:44', 4, 100),
(14, 1, 'J\'ai un souci avec ce forum', 'Est ce qu\'un admin pourait m\'aider', 0, 'actif', '2026-05-04 00:13:09', '2026-05-04 00:13:10', 3, 90),
(25, 1, 'sqlkmdsfqlksjdflkqsdf', 'qfdn:fqjsdlkflqsdkfjlqmlsdfqsdflmqdsjf', 0, 'actif', '2026-05-05 09:33:18', '2026-05-05 09:33:18', 7, NULL),
(26, 1, 'dqfksmdklfjqsdlmkfjlkqsdf', 'qsdfmlkjqsdjflmqsdjflqsjdf', 0, 'masque', '2026-05-05 09:33:57', '2026-05-05 09:34:00', 7, 0),
(27, 1, 'Salut', 'Je suis nouveau', 0, 'actif', '2026-05-05 09:35:22', '2026-05-05 09:35:26', 1, 90);
...
INSERT INTO `reply` (`id`, `post_id`, `user_id`, `parent_reply_id`, `contenu`, `statut`, `created_at`, `updated_at`, `ai_score`) VALUES
(10, 27, 2, NULL, 'Bienvenue sur Green Assurance ! Nous sommes ravis de vous accueillir parmi nous. N\'hésitez pas à explorer le forum et à participer aux discussions. Merci de respecter les règles du forum.', 'actif', '2026-05-05 09:35:28', '2026-05-05 09:35:28', NULL);
...
(1, 'Youssef', 'Jallouli', 'youssefjall@icloud.com', '$2a$12$UNAVXJV.oh2mU9BKiYIFPOyLoftalUo683FpYd6OP98hhw14jk4M.', NULL, NULL, 'active', '2026-04-21 08:38:18', '2026-05-05 08:42:52'),
(2, 'Auto', 'Repondeur', 'contact@nutrivert.tn', '$2a$12$fValj0t15WXQn.sgIGSFq.5RGDsmAu2Rki/bbFm0gaXMK4Guusupm', '0000000000', NULL, 'active', '2026-05-04 09:32:36', '2026-05-04 09:32:36');
