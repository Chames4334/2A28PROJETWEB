<?php
// view/frontoffice/accueil.php - Page d'accueil Green Assurance
...
<head>
    ...
    <title>Green Assurance - Assurance Santé, Accident, Auto, Habitation</title>
...
<div class="page-wrapper">
    ...
    <h2 style="text-align: center; margin-bottom: 40px;" id="services">Nos assurances</h2>
    <div class="services">
        <div class="service-card">
            <i class="fas fa-heartbeat"></i>
            <h3>Assurance Santé</h3>
            <p>Protégez votre santé avec nos formules complètes. Remboursements rapides, large panel de soins, et prévention incluse.</p>
            <a href="../auth/register.php" style="color: olivedrab; text-decoration: none; font-weight: 600; display: inline-block; margin-top: 15px;">➜ Je découvre</a>
        </div>
        <div class="service-card">
            <i class="fas fa-briefcase-medical"></i>
            <h3>Assurance Accident</h3>
            <p>Indemnisation en cas d'accident de la vie. Invalidité, incapacité, capital décès. Une protection essentielle au quotidien.</p>
            <a href="../auth/register.php" style="color: olivedrab; text-decoration: none; font-weight: 600; display: inline-block; margin-top: 15px;">➜ Je découvre</a>
        </div>
        <div class="service-card">
            <i class="fas fa-car"></i>
            <h3>Assurance Auto</h3>
            <p>Protégez votre véhicule avec nos formules éco-responsables. Bonus pour véhicules propres et assistance 24/7.</p>
            <a href="../auth/register.php" style="color: olivedrab; text-decoration: none; font-weight: 600; display: inline-block; margin-top: 15px;">➜ Je découvre</a>
        </div>
        <div class="service-card">
            <i class="fas fa-home"></i>
            <h3>Assurance Habitation</h3>
            <p>Protégez votre logement et vos biens. Garanties complètes contre les risques du quotidien.</p>
            <a href="../auth/register.php" style="color: olivedrab; text-decoration: none; font-weight: 600; display: inline-block; margin-top: 15px;">➜ Je découvre</a>
        </div>
    </div>
