...
<head>
    <meta charset="UTF-8">
    <title>Front Office - Nouvelle demande</title>
    ...
    <div class="page-shell">
        ...
        <section class="form-card">
            ...
            <form id="form-conge" method="post" action="?action=create" onsubmit="return validateCongeForm();">
                ...
                <input type="text" id="date_debut" name="date_debut" value="<?php echo htmlspecialchars($_POST['date_debut'] ?? ''); ?>">

                <label for="date_fin">Date de fin (AAAA-MM-JJ)</label>
                <input type="text" id="date_fin" name="date_fin" value="<?php echo htmlspecialchars($_POST['date_fin'] ?? ''); ?>">

                <label for="type_conge">Type de congé</label>
                <input type="text" id="type_conge" name="type_conge" value="<?php echo htmlspecialchars($_POST['type_conge'] ?? ''); ?>">
                ...
                <input type="text" id="date_demande" name="date_demande" value="<?php echo htmlspecialchars($_POST['date_demande'] ?? date('Y-m-d')); ?>">

                <label for="id_employe">ID employé</label>
                <input type="text" id="id_employe" name="id_employe" value="<?php echo htmlspecialchars($_POST['id_employe'] ?? ''); ?>">
